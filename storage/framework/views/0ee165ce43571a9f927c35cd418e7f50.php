            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('events.index')); ?>" class="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">
                            My Events
                        </a>
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="bg-indigo-600 text-white hover:bg-indigo-700 px-4 py-2 rounded-md text-sm font-medium transition">
                            Sign up
                        </a>
                    <?php endif; ?>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="py-16 md:py-24 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('events.create')); ?>" class="px-8 py-4 bg-indigo-600 text-white text-lg font-semibold rounded-lg hover:bg-indigo-700 transition shadow-lg hover:shadow-xl">
                        Create Your First Event
                    </a>
                    <a href="<?php echo e(route('events.index')); ?>" class="px-8 py-4 bg-white text-indigo-600 text-lg font-semibold rounded-lg hover:bg-gray-50 transition border-2 border-indigo-600">
                        View My Events
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-indigo-600 text-white text-lg font-semibold rounded-lg hover:bg-indigo-700 transition shadow-lg hover:shadow-xl">
                        Get Started Free
                    </a>
                    <a href="<?php echo e(route('login')); ?>" class="px-8 py-4 bg-white text-indigo-600 text-lg font-semibold rounded-lg hover:bg-gray-50 transition border-2 border-indigo-600">
                        Sign In
                    </a>
                <?php endif; ?>
            </div>
    ...
    <footer class="bg-white border-t border-gray-200 mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <p class="text-center text-gray-500 text-sm">
                © <?php echo e(date('Y')); ?> ScheduleMaker. All rights reserved.
            </p>
        </div>
    </footer>
...
<?php /**PATH C:\Users\astro\Herd\ScheduleMaker-app\resources\views/welcome.blade.php ENDPATH**/ ?>